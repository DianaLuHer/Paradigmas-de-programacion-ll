...
Descripción: Usos de los tipos básico de datos en Python.
'''
...
print("Tipo de dato decimal:", mi_variable_decimal) #Imprime el contenido de mi_variable_decimal

# Cadena de texto
mi_variable_texto_nombre = "Diana"
mi_variable_texto_apellido = 'Luna'
print("Cadena de texto:", mi_variable_texto_nombre, mi_variable_texto_apellido) # Imprime el nombre y el apellido

# Booleno
mi_variable_booleana = True
print('Tipo booleano:', mi_variable_booleana) #Imprime True que es el contenido de mi_variable_booleana
...
print("Ejemplo de convención de una constante:", VARIABLE_CONSTANTE) #Imprime el contenido de Variable_constante
